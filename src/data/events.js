export const recurringEvents = [
  ...
  },
  {
    ...
    description: 'Καλλιτέχνες: Δημήτρης Ζαβογιάννης - Μαριαλένα Μαρούλη - Χρήστος Ιατρού',
    time: '21:30',
  ...
  },
  {
    ...
    description: 'Καλλιτέχνες: Δημήτρης Ζαβογιάννης - Σωτήρης Παπαϊωάννου - Πέτρος Τριανταφύλλου',
    time: '14:30',
    genre: 'Παλαιά λαϊκά / Ρεμπέτικα',
