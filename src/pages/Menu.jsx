...
export default function Menu() {
  ...
  return (
    <PageTransition>
      ...
      <section className="section-padding pt-6 pb-10 sm:pt-8">
        <div className="container-wide">
          <SectionReveal className="mx-auto mb-8 max-w-5xl text-center">
            <nav
              className="menu-carousel flex snap-x snap-mandatory items-center gap-3 overflow-x-auto py-1"
