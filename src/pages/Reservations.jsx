              ...
              <SectionReveal className="space-y-6 text-center lg:sticky lg:top-28 lg:text-left">
                ...
                <div className="border-t border-[rgba(127,91,48,0.12)] pt-6">
                  ...
                  <p className="text-xs leading-relaxed text-[rgba(47,29,15,0.56)]">
                    Για ιδιωτικές εκδηλώσεις, party, μνημόσυνα κλπ. επικοινωνήστε μαζί μας τηλεφωνικά. Επίσης επειδή το σύστημα δέχεται κρατήσεις μόνο τις ημέρες λειτουργίας, σε περίπτωση που εκάκτως είμαστε μέσα στον χρόνο ανοιχτά κάποια Δευτέρα κάντε την κράτησή σας τηλεφωνικά κατ' εξαίρεση.
                  </p>
                </div>
