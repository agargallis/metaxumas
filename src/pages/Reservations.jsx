  ...
  return (
    ...
    >
      ...
      <p className="mx-auto max-w-md text-sm leading-relaxed text-[rgba(47,29,15,0.6)]">
        Σε ευχαριστούμε. Θα επικοινωνήσουμε μαζί σου σύντομα για επιβεβαίωση.
        Αν δεν λάβεις απάντηση εντός 24 ωρών, παρακαλούμε επικοινώνησε μαζί μας τηλεφωνικά.
      </p>
                    ...
                    <div className="border-t border-[rgba(127,91,48,0.12)] pt-4 text-center text-xs leading-relaxed text-[rgba(47,29,15,0.44)] sm:text-left">
                      <p className="flex flex-col items-center gap-2 text-center sm:flex-row sm:items-start sm:text-left">
                        ...
                        <span>
                          ...
                          Η επιβεβαίωση θα σου σταλεί μέσω email ή τηλεφώνου εντός 24 ωρών. Για επείγουσες
                          κρατήσεις ή για αύριο, παρακαλούμε επικοινώνησε τηλεφωνικά. Οι κρατήσεις για βραδιές
              ...
              <SectionReveal className="space-y-6 text-center lg:sticky lg:top-28 lg:text-left">
                ...
                <div className="border-t border-[rgba(127,91,48,0.12)] pt-6">
                  ...
                  <p className="text-xs leading-relaxed text-[rgba(47,29,15,0.56)]">
                    Για ιδιωτικές εκδηλώσεις, party, μνημόσυνα κλπ. επικοινώνησε μαζί μας τηλεφωνικά. Επίσης επειδή το σύστημα δέχεται κρατήσεις μόνο τις ημέρες λειτουργίας, σε περίπτωση που εκάκτως είμαστε μέσα στον χρόνο ανοιχτά κάποια Δευτέρα κάνε την κράτησή σου τηλεφωνικά κατ' εξαίρεση.
                  </p>
                </div>
