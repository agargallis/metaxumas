                    ...
                    {business.social.instagram && (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[rgba(47,29,15,0.42)]">@metaxu.mas</p>
                        </div>
                    ...
                    {business.social.facebook && (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[rgba(47,29,15,0.42)]">Μεταξύ Μας</p>
                        </div>
                        <ExternalLink size={12} className="ml-auto text-[rgba(47,29,15,0.26)] group-hover:text-[rgba(47,29,15,0.46)] transition-colors" />
                      </a>
                    )}
                ...
                <div className="card-base p-7">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      { q: 'Υπάρχει parking;', a: 'Υπάρχει δημοτικός χώρος στάθμευσης κοντά στο κατάστημα.' },
                      { q: 'Δέχεστε κατοικίδια;', a: 'Στον εξωτερικό χώρο δεχόμαστε φιλικά κατοικίδια.' },
